...
crimetypes = features[:-1]  # Cut out the year coloumn

# add markdown text
markdown_text = """
Data used for this dashboard was taken from the US Department of Justice. [Source.](https://ucr.fbi.gov/crime-in-the-u.s/2016/crime-in-the-u.s.-2016/topic-pages/tables/table-1)
"""
